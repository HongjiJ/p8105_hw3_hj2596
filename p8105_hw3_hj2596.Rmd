...
Because here I am making a scatterplot with lots of data, there’s a limit to how much you can avoid overplotting using alpha levels. Using 'geom_hex()' is a way to avoid that.
```{r}
tmax_vs_tmin = 
  noaa_df %>%
  drop_na(tmin, tmax) %>%
